...
namespace StandardCommon
{
    public static partial class Helper
    {
        ...
        private const string AES_IV = "z7nwT6Awi47hbxND";
        private const string AES_KEY = "NDWDwzf3Hst3fqkq";
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string EncryptText(string text, string aes_iv = AES_IV, string aes_key = AES_KEY)
        {
            if (text._isEmpty()) return "";
            try {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string DecryptText(string text, string aes_iv = AES_IV, string aes_key = AES_KEY)
        {
            if (text._isEmpty()) return "";
            try {
                using (var aes = new AesManaged()) {
