...
namespace StandardCommon
{
    ...
    public static class IntExtensions
    {
        ...
        /// <param name="val"></param>
        /// <returns></returns>
        public static int _value(this int? val)
        {
    ...
    public static class ArrayExtensions
    {
        ...
        /// <summary>
        /// 配列の先頭の要素を取得する。配列が空なら default(T) を返す。
        /// </summary>
        public static T _first<T>(this T[] ary)
        {
            return ary._getFirst();
        }
        ...
        /// <summary>
        /// 配列の末尾の要素を取得する。配列が空なら default(T) を返す。
        /// </summary>
        public static T _last<T>(this T[] ary)
        {
            return ary._isEmpty() ? default(T) : ary.Last();
        }

        /// <summary>
        /// 配列の2番目の要素を取得する。配列長が2未満なら default(T) を返す。
        /// </summary>
        public static T _second<T>(this T[] ary)
        {
            return ary._getSecond();
        }
        ...
        /// <summary>
        /// 配列の3番目の要素を取得する。配列長が3未満なら default(T) を返す。
        /// </summary>
        public static T _third<T>(this T[] ary)
        {
            return ary._getThird();
        }
        ...
        /// <returns></returns>
        public static T[] _extend<T>(this T[] array, int num)
        {
            if (num < 0) num = 0;
            if (array._isEmpty()) {
                array = new T[num];
        ...
        public static T[] _extend<T>(this T[] array, int num, T fillVal)
        {
    ...
    public static class StringExtension
    {
        ...
        public static char? _nth(this string str, int idx)
        {
        ...
        /// <summary>
        /// 整数に解釈されるべき文字列を整数値に変換する。エラーなら ERROR_INT_VAL を返し、空文字列なら emptyVal を返す。
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static int _parseInt(this string str, int emptyVal = Helper.ERROR_INT_VAL)
        {
            try {
        ...
        /// <summary>
        /// 必要なら末尾に @ を付加する (末尾が空白や @ の場合)
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string _appendAtMarkIfNecessary(this string str)
        {
            return str._isEmpty() ? "" : str.EndsWith(" ") || str.EndsWith("@") ? str + "@" : str;
        }
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static bool _isDeletedId(this string str)
        {
            return Helper.isDeletedId(str);
        }
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static bool _notDeletedId(this string str)
        {
            return !Helper.isDeletedId(str);
        }
        ...
        /// 文字列を暗号化する
        /// </summary>
        public static string _encrypt(this string str)
        {
            return Helper.EncryptText(str);
        }

        /// <summary>
        /// 文字列を平文化する
        /// </summary>
        public static string _decrypt(this string str)
        {
            return Helper.DecryptText(str);
        }
    ...
    public static class IEnumerableExtension
    {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static (int index, T value) _top1<T>(this IEnumerable<T> list) where T: IComparable
        {
            return list._enumerate().Aggregate((max, w) => max.value.CompareTo(w.value) >= 0 ? max : w);
        }
        ...
        public static double _dotProduct(this IEnumerable<double> list1, IEnumerable<double> list2)
        {
            return list1.Zip(list2, (x, y) => x * y).Sum();
        }
